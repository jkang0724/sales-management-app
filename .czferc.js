...
/**
 * @typedef {{ticketNumber: string; type: string; scope: string; subject: string; body: string; breakingBody: string; breaking: string; issuesBody: string; issues: string;}} Answers
 */
